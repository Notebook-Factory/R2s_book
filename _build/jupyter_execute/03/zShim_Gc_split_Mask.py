...
masks_zShim_Gc_split_path = ["data/bet_mag_echo1_zShim_Gc_split_alpha_60deg.nii","data/bet_mag_echo1_zShim_Gc_split_alpha_60deg_mask.nii"]
masks_zShim_Gc_split_titles = ["Scan","Mask"]

n=20

layers = []
for path in masks_zShim_Gc_split_path:
...
compare_scans(mapp_layers,masks_zShim_Gc_split_titles,n,"fig23.html")
display(HTML('fig23.html'))