...
raw_images_path = ["data/mag_echo1_zShim_off_alpha_60deg.nii", "data/mag_echo2_zShim_off_alpha_60deg.nii","data/mag_echo3_zShim_off_alpha_60deg.nii"]
...
n=n-1
for i in range(n+1):
    mapp_layer.append(mapp(layers[0][i],[0,32],[0,255]))
mapp_layers.append(mapp_layer)

mapp_layer=[]
for i in range(n+1):
     mapp_layer.append(mapp(layers[1][i],[0,32],[0,255]))
mapp_layers.append(mapp_layer)

mapp_layer=[]
for i in range(n+1):
     mapp_layer.append(mapp(layers[2][i],[0,32],[0,255]))
mapp_layers.append(mapp_layer)

compare_scans(mapp_layers,n,"fig34.html")
