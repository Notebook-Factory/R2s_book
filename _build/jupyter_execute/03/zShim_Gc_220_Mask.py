...
masks_zShim_Gc_220_path = ["data/bet_mag_echo1_zShim_Gc_220_alpha_60deg.nii","data/bet_mag_echo1_zShim_Gc_220_alpha_60deg_mask.nii"]
masks_zShim_Gc_220_titles = ["Scan","Mask"]

n=20

layers = []
for path in masks_zShim_Gc_220_path:
...
compare_scans(mapp_layers,masks_zShim_Gc_220_titles,n,"fig22.html")
display(HTML('fig22.html'))