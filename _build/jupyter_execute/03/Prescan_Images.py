...
raw_images_path = ["data/mag_echo1_ref_scan.nii","data/mag_echo2_ref_scan.nii","data/mag_echo3_ref_scan.nii"]
raw_images_titles = ["Echo1_ref_scan","Echo2_ref_scan","Echo3_ref_scan"]
...
n=n-1
for i in range(n+1):
    mapp_layer.append(mapp(layers[0][i],[0,530],[0,255]))
mapp_layers.append(mapp_layer)

mapp_layer=[]
for i in range(n+1):
     mapp_layer.append(mapp(layers[1][i],[0,530],[0,255]))
mapp_layers.append(mapp_layer)

mapp_layer=[]
for i in range(n+1):
     mapp_layer.append(mapp(layers[2][i],[0,530],[0,255]))
mapp_layers.append(mapp_layer)

compare_scans(mapp_layers,raw_images_titles,n,"fig31.html")
display(HTML('fig31.html'))